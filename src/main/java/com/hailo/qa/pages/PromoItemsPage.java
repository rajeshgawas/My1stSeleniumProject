...
public class PromoItemsPage extends TestBase {
	...
	public void selectCategory() throws InterruptedException {
		...
		selObj.selectByVisibleText("Product");
		System.out.println("Product");
		selObj.selectByVisibleText("Music");
		System.out.println("Music");
		selObj.selectByVisibleText("Cost Control");
		System.out.println("Cost Control");
		selObj.selectByVisibleText("Health & Safety");
		System.out.println("Health & Safety");
		selObj.selectByVisibleText("Training Videos");
		System.out.println("Training Videos");
		Thread.sleep(2000);
...
//		Add_button.click();
	...
	public void selectEndDate() throws InterruptedException {
		...
		promo_Item_EndDate_cal.sendKeys(Keys.ENTER);
//		Date date = new Date();
