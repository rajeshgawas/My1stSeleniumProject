...
public void doLogin() throws InterruptedException {
	...
	driver.findElement(By.name("email")).sendKeys("qatest1@mailinator.com");
	...
	public void addUser() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@name='userEmailId']")).sendKeys("testuser101@mailinator.com");
		Thread.sleep(2000);
