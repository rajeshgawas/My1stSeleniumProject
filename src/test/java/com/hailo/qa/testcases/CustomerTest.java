...
//		}
	...
	public void toggleUserStatus() throws InterruptedException {
		...
		logger.info("========Login with Customer User==============");
		dashboard = new Dashboard();
		Thread.sleep(2000);//button[@class='is-active dropdown-btn nav-link']/span[text()='My Store']);
		logger.info("========Navigate to Store page==============");
		customer.navigateToStorePage();
		Thread.sleep(1000);
		//customer.navigateToEditStorePage();
		Thread.sleep(2000);
